...
suite "lsp_handler module tests":
  ...
  test "handleDocumentFormatting with disabled formatting":
    ...
    # Add a test document
    handler.documents["file:///test.nim"] = Document(content: "test content", version: 1)
  ...
  test "handleDocumentFormatting with enabled formatting":
    ...
    scenarioManager.scenarios["formatting_test"] = Scenario(
      ...
      semanticTokens: SemanticTokensConfig(enabled: false, tokens: @[]),
      inlayHint: InlayHintConfig(enabled: false, hints: @[]),
      declaration: DeclarationConfig(enabled: false, location: DeclarationContent(uri: "", range: Range(start: Position(line: 0, character: 0), `end`: Position(line: 0, character: 0))), locations: @[]),
      definition: DefinitionConfig(enabled: false, location: DefinitionContent(uri: "", range: Range(start: Position(line: 0, character: 0), `end`: Position(line: 0, character: 0))), locations: @[]),
      typeDefinition: TypeDefinitionConfig(enabled: false, location: TypeDefinitionContent(uri: "", range: Range(start: Position(line: 0, character: 0), `end`: Position(line: 0, character: 0))), locations: @[]),
      implementation: ImplementationConfig(enabled: false, location: ImplementationContent(uri: "", range: Range(start: Position(line: 0, character: 0), `end`: Position(line: 0, character: 0))), locations: @[]),
      references: ReferenceConfig(enabled: false, locations: @[], includeDeclaration: true),
      documentHighlight: DocumentHighlightConfig(enabled: false, highlights: @[]),
      rename: RenameConfig(enabled: false, workspaceEdit: RenameWorkspaceEdit(changes: @[], documentChanges: @[])),
      formatting: FormattingConfig(
        ...
        edits: @[
          ...
          FormattingContent(
            range: Range(start: Position(line: 5, character: 2), `end`: Position(line: 5, character: 10)),
            newText: "    return;"
          )
        ]
      ),
      delays: DelayConfig(hover: 0, completion: 0, diagnostics: 0, semanticTokens: 0, inlayHint: 0, declaration: 0, definition: 0, typeDefinition: 0, implementation: 0, references: 0, documentHighlight: 0, rename: 0, formatting: 0),
      errors: initTable[string, ErrorConfig](),
    )
  ...
  test "handleDocumentFormatting with delay":
    ...
    scenarioManager.scenarios["formatting_delay"] = Scenario(
      ...
      delays: DelayConfig(hover: 0, completion: 0, diagnostics: 0, semanticTokens: 0, inlayHint: 0, declaration: 0, definition: 0, typeDefinition: 0, implementation: 0, references: 0, documentHighlight: 0, rename: 0, formatting: 100),
      errors: initTable[string, ErrorConfig](),
    )
