...
proc handleInlayHintResolve(
  ...
  try:
    let response = await server.lspHandler.handleInlayHintResolve(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleDocumentSymbol(server: LSPServer, id: JsonNode, params: JsonNode) {.async.} =
  try:
    let response = await server.lspHandler.handleDocumentSymbol(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleWorkspaceSymbol(
  ...
  try:
    let response = await server.lspHandler.handleWorkspaceSymbol(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleWorkspaceSymbolResolve(
  ...
  try:
    let response = await server.lspHandler.handleWorkspaceSymbolResolve(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleDocumentLinkResolve(
  ...
  try:
    let response = await server.lspHandler.handleDocumentLinkResolve(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleSelectionRange(server: LSPServer, id: JsonNode, params: JsonNode) {.async.} =
  try:
    let response = await server.lspHandler.handleSelectionRange(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleCodeLens(server: LSPServer, id: JsonNode, params: JsonNode) {.async.} =
  try:
    let response = await server.lspHandler.handleCodeLens(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleCodeActionResolve(
  ...
  try:
    let response = await server.lspHandler.handleCodeActionResolve(id, params)
    await server.sendResponse(id, response)
  except LSPError as e:
    await server.sendError(-32603, e.msg, id)
...
proc handleMessage*(server: LSPServer, message: JsonNode) {.async.} =
  ...
  of "inlayHint/resolve":
    await server.handleInlayHintResolve(id, params)
  ...
  of "workspace/symbol":
    await server.handleWorkspaceSymbol(id, params)
  of "workspaceSymbol/resolve":
    await server.handleWorkspaceSymbolResolve(id, params)
  of "textDocument/documentLink":
    await server.handleDocumentLink(id, params)
  of "documentLink/resolve":
    await server.handleDocumentLinkResolve(id, params)
